        ...
        if link_mode == "linked_file" and local_path:
            ...
            if local_path:
                ...
                if pdf_source_path.exists():
                    # Just try to use the file directly - OneDrive/cloud services
                    ...
                    try:
                        ...
                        error_msg = (
                            f"Cannot read file: {pdf_source_path}. "
                            f"Error: {e}. "
                            f"If this is a cloud-synced file (OneDrive/Dropbox), "
                            f"please ensure the sync service is running and try again."
                        )
                        logger.error(error_msg)
